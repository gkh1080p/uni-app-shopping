<template>
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      <!-- 商品主图 -->
      <view class="preview" v-if="goods && goods.mainPictures">
      ...
      <view class="action">
        ...
        <view class="item arrow" @tap="onpenPopup('address')">
          <text class="label">送至</text>
          <text class="text ellipsis"> 请选择收获地址 </text>
        </view>
        <view class="item arrow" @tap="onpenPopup('service')">
...
const getGoodsData = async () => {
  const res = await getGoodsAPI(query)
...
const onpenPopup = (name: typeof popupName.value) => {
  // 修改弹出层名称
